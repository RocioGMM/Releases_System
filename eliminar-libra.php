...
//$id_categ = $_REQUEST["id_categ"];
	...
	$sql1 = "SELECT * FROM libramientos WHERE id='".$id."' ORDER BY id ASC";
...
<form method="post" action="panel/b_libra.php?id=<?php echo $row["id"];?>&id2=<?php echo $id;?>" name="frmRegistro">
<div class="onecol"><span class="titlecol-ad">Eliminar Libramiento </span>
  
    <input type="hidden" name="id" value="<?php echo $row["id"];?>"/>

<div class="campitem">
<?php echo $row["expediente"].' ('.$row["nombre"].')';?>
</div>
